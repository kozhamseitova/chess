                ...
                <div class="row justify-content-center h-100">
                    ...
                    <div class=" chat">
                        <div class="card">
                            ...
                            <c:forEach items="${messages}" var="messager">
                                <div class="d-flex justify-content-start mb-4 mr-5">
                                    <div class="msg_cotainer">
                                        <p>${messager.email} >> ${messager.message}</p>
...
-->
                                    <input name="textInput" type="text" class="form-control type_msg" placeholder="Type your message...">
